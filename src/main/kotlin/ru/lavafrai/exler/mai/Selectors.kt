...
class Selectors {
    companion object {
        const val FACULTIES_NAME_SELECTOR = "body > center > table > tbody > tr > td:nth-child(1) > table:nth-child(2) > tbody > tr > td > div:nth-child(1) > table > tbody > tr > td > table > tbody > tr > td:nth-child(3) > div > b"
